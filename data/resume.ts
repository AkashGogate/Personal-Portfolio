  ...
  coursework: [
    {
      ...
      courses: [
        ...
        },
        {
          ...
          description: "Deploying distributed systems to store and analyze large datasets — unstructured and structured storage, streaming data pipelines, and training ML models, primarily in Python.",
          proficiency: 3,
